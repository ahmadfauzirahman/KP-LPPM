...
use common\models\KategoriBarangSearch;
...
class KategoriBarangController extends Controller
{
            ...
            */
            ...
            if ($request->isGet) {
                ...
                if (!empty($foto) && $foto->size !== 0) {
                    $foto->saveAs(Yii::$app->basePath . "/web/foto-barang/" . $foto->name);
                ...
                return [
                    ...
                    'title' => "Create new KategoriBarang",
                    'content' => '<span class="text-success">Tambah Kategori Barang Suskes</span>',
                    'footer' => Html::button('Close', ['class' => 'btn btn-default pull-left', 'data-dismiss' => "modal"]) .
    ...
    public function actionUpdate($id)
    {
        ...
        if ($request->isAjax) {
            ...
            */
            ...
            if ($request->isGet) {
                return [
                    'title' => "Update KategoriBarang #" . $id,
    ...
    /**
     * Delete an existing KategoriBarang model.
     * For ajax request will return json object
    ...
    /**
     * Delete multiple existing KategoriBarang model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
