        ...
        if ($request->isAjax) {
            ...
            */
            ...
            if ($request->isGet) {
                ...
                if (!empty($foto) && $foto->size !== 0) {
                    $foto->saveAs(Yii::$app->basePath . "/web/barang/" . $foto->name);
                ...
                return [
                    ...
                    'content' => '<span class="text-success">Tambah Barang Success</span>',
                    'footer' => Html::button('Close', ['class' => 'btn btn-default pull-left', 'data-dismiss' => "modal"]) .
